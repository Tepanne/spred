...
const spreadsheetId = '16Z_g2OXbNZ4wgpo6r6O6pahzW2_uHA_3FRVFuhQYoMU'; // Ganti dengan ID spreadsheet Anda
...
app.post('/login', async (req, res) => {
  ...
  try {
    ...
    if (rows && rows.length > 0) {
      // Cek setiap baris: kolom A (username), B (password), dan pastikan email valid di kolom C
...
// Ekspor app sebagai module (tanpa app.listen, karena Vercel akan menangani request)
module.exports = app;